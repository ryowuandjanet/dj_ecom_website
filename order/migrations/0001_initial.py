...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('cart', '0003_alter_coupon_required_amount_to_use_coupon'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Recieved', 'Recieved'), ('Delivered', 'Delivered'), ('On the way', 'On the way')], max_length=15)),
